...
// ========== 设备数据 ==========
var equipmentData = [
  { id:'EQ-001', name:'门机MH-01', model:'MQ4035', category:'起重机械', serviceLife:25, installDate:'2012-06-15', unitParent:'深圳市盐田港股份有限公司', unitDept:'安全管理部', project:'盐田港区集装箱码头扩建工程', responsible:'张建国', lastInspection:'2026-05-18', nextMaint:'2026-05-20', status:'正常使用', isSpecial:true, inspFreq:'每日', inspItems:12, maintCycle:'每月', maintOrg:'中集维保', location:'1号泊位' },
  { id:'EQ-002', name:'岸桥QC-01', model:'ZPMC-65T', category:'起重机械', serviceLife:30, installDate:'2015-03-20', unitParent:'深圳市盐田港股份有限公司', unitDept:'安全管理部', project:'盐田港区集装箱码头扩建工程', responsible:'李明华', lastInspection:'2026-05-20', nextMaint:'2026-06-15', status:'正常使用', isSpecial:true, inspFreq:'每日', inspItems:15, maintCycle:'每季度', maintOrg:'振华维保', location:'2号泊位' },
  { id:'EQ-003', name:'门机MH-03', model:'MQ2533', category:'起重机械', serviceLife:20, installDate:'2008-09-10', unitParent:'深圳市华舟海洋发展股份有限公司', unitDept:'安全管理部', project:'华舟海洋装备修造项目', responsible:'王海涛', lastInspection:'2026-05-19', nextMaint:'2026-05-22', status:'维修中', isSpecial:true, inspFreq:'每日', inspItems:12, maintCycle:'每月', maintOrg:'自维保', location:'修造车间' },
  { id:'EQ-004', name:'集卡YT-012', model:'SITRAK C7H', category:'场内机动车辆', serviceLife:10, installDate:'2021-08-05', unitParent:'深圳市深圳港物流集团有限公司', unitDept:'安全管理部', project:'前海综合枢纽运营项目', responsible:'赵志强', lastInspection:'2026-05-17', nextMaint:'2026-06-05', status:'正常使用', isSpecial:false, inspFreq:'每周', inspItems:8, maintCycle:'每季度', maintOrg:'重汽服务', location:'堆场A区' },
  { id:'EQ-005', name:'QT-001 桥式起重机', model:'QD50/10T', category:'起重机械', serviceLife:20, installDate:'2010-04-22', unitParent:'深圳市深圳港港口服务集团有限公司', unitDept:'安全管理部', project:'蛇口港区旧码头改造工程', responsible:'陈国栋', lastInspection:'2026-05-20', nextMaint:'2026-06-15', status:'正常使用', isSpecial:true, inspFreq:'每周', inspItems:10, maintCycle:'每季度', maintOrg:'自维保', location:'仓库B' },
  { id:'EQ-006', name:'QT-003 电梯', model:'OTIS 3200', category:'电梯', serviceLife:15, installDate:'2018-11-30', unitParent:'深圳市深圳港港口服务集团有限公司', unitDept:'安全管理部', project:'港口大厦物业管理项目', responsible:'林小燕', lastInspection:'2026-05-10', nextMaint:'2026-05-22', status:'正常使用', isSpecial:true, inspFreq:'每月', inspItems:20, maintCycle:'每半年', maintOrg:'奥的斯维保', location:'港口大厦' },
  { id:'EQ-007', name:'消防水泵组FP-01', model:'XBD12/30', category:'消防设施', serviceLife:15, installDate:'2016-07-18', unitParent:'深圳市盐田港股份有限公司', unitDept:'安全管理部', project:'盐田港区智能闸口改造项目', responsible:'周伟', lastInspection:'2026-05-15', nextMaint:'2026-07-01', status:'正常使用', isSpecial:false, inspFreq:'每月', inspItems:6, maintCycle:'每半年', maintOrg:'自维保', location:'消防泵房' },
  { id:'EQ-008', name:'视频监控阵列VS-01', model:'HK-DS2CD', category:'安防设备', serviceLife:8, installDate:'2022-03-10', unitParent:'深圳市深圳港港口服务集团有限公司', unitDept:'安全管理部', project:'港口大厦物业管理项目', responsible:'杨帆', lastInspection:'2026-05-16', nextMaint:'2026-08-10', status:'正常使用', isSpecial:false, inspFreq:'每周', inspItems:5, maintCycle:'每年', maintOrg:'海康服务', location:'监控中心' },
  { id:'EQ-009', name:'储气罐PV-002', model:'2m³/1.0MPa', category:'压力容器', serviceLife:10, installDate:'2019-05-25', unitParent:'深圳市深圳港能源发展有限公司', unitDept:'安全管理部', project:'大鹏LNG接收站配套工程', responsible:'吴海', lastInspection:'2026-05-20', nextMaint:'2026-06-25', status:'正常使用', isSpecial:true, inspFreq:'每日', inspItems:8, maintCycle:'每月', maintOrg:'特检院', location:'LNG站区' },
  { id:'EQ-010', name:'正面吊RS-03', model:'KALMAR DCE80', category:'场内机动车辆', serviceLife:12, installDate:'2020-01-15', unitParent:'深圳市盐田港股份有限公司', unitDept:'安全管理部', project:'盐田港区集装箱码头扩建工程', responsible:'孙磊', lastInspection:'2026-05-18', nextMaint:'2026-06-18', status:'停用', isSpecial:false, inspFreq:'每周', inspItems:10, maintCycle:'每季度', maintOrg:'卡尔玛服务', location:'堆场C区' },
  { id:'EQ-011', name:'门机MH-05', model:'MQ4027', category:'起重机械', serviceLife:25, installDate:'2011-02-28', unitParent:'深圳市深圳港海洋发展有限公司', unitDept:'安全管理部', project:'大铲湾蓝色未来科技园运营项目', responsible:'刘强', lastInspection:'2026-05-19', nextMaint:'2026-06-20', status:'正常使用', isSpecial:true, inspFreq:'每日', inspItems:12, maintCycle:'每月', maintOrg:'中集维保', location:'大铲湾码头' },
  { id:'EQ-012', name:'消防炮塔FT-02', model:'PS40D', category:'消防设施', serviceLife:20, installDate:'2014-10-08', unitParent:'深圳市盐田港股份有限公司', unitDept:'安全管理部', project:'盐田港区集装箱码头扩建工程', responsible:'黄志远', lastInspection:'2026-05-12', nextMaint:'2026-08-08', status:'正常使用', isSpecial:false, inspFreq:'每月', inspItems:4, maintCycle:'每半年', maintOrg:'自维保', location:'码头前沿' }
];
