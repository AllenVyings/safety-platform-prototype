...
function switchTab(name) {
  var listRoot = document.getElementById('view-list');
  if (!listRoot) return;
  listRoot.querySelectorAll('.tab-item').forEach(function(t) { t.classList.remove('active'); });
  listRoot.querySelectorAll('.tab-content').forEach(function(t) { t.classList.remove('active'); });
  var tabItems = listRoot.querySelectorAll('.tab-item');
