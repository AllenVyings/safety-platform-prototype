      ...
      document.addEventListener('click', function(e) {
        ...
        switch (action) {
          ...
          case 'showEvalList':
            ...
            break;
          case 'filterList':
            self.filterTable('tab-kanban');
            break;
          case 'resetListFilter':
            self.resetFilter('tab-kanban');
            break;
          case 'filterReport':
          ...
          case 'exportData':
            ...
            break;
          case 'editChecklist':
            showToast('编辑履职清单（原型演示）', 'info');
            break;
          case 'deleteChecklist':
            showConfirm('确定删除该履职清单项？', function() { showToast('已删除', 'success'); });
            break;
          case 'viewSourceRecord':
            showToast('查看来源记录（原型演示）', 'info');
            break;
        }
      });
    },
