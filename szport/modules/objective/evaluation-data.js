...
(function() {
  ...
  var EvaluationData = {
    ...
    detailTitles: {
      ...
      'detail-3': '危化品仓储公司安全员 — 履职项明细',
      'detail-4': '港口运营公司安全总监 — 履职项明细',
      'eval-1': '履职得分数据溯源 — 张明'
    },
    ...
    dutyItems: {
      ...
      'detail-3': [
        { name: '危化品仓库巡检', freq: '每日1次', done: 22, required: 22, status: '已完成', statusCls: 'tag-success', source: '检查记录', sourceCls: 'source-check' },
        { name: '危化品入库查验', freq: '按需', done: 8, required: 8, status: '已完成', statusCls: 'tag-success', source: '检查记录', sourceCls: 'source-check' },
        { name: '参加安全培训', freq: '每季度1次', done: 1, required: 2, status: '进行中', statusCls: 'tag-info', source: '培训记录', sourceCls: 'source-train' },
        { name: '提交安全日报', freq: '每日1次', done: 20, required: 22, status: '进行中', statusCls: 'tag-info', source: '手动填报', sourceCls: 'source-manual' }
      ],
      'detail-4': [
        { name: '组织安全检查', freq: '每月2次', done: 8, required: 10, status: '进行中', statusCls: 'tag-info', source: '检查记录', sourceCls: 'source-check' },
        { name: '参加安全培训', freq: '每季度1次', done: 2, required: 2, status: '已完成', statusCls: 'tag-success', source: '培训记录', sourceCls: 'source-train' },
        { name: '参与应急演练', freq: '每半年1次', done: 0, required: 1, status: '逾期', statusCls: 'tag-error', source: '演练记录', sourceCls: 'source-drill' },
        { name: '隐患整改督办', freq: '按需', done: 2, required: 5, status: '进行中', statusCls: 'tag-info', source: '检查记录', sourceCls: 'source-check' },
        { name: '专项检查配合', freq: '按需', done: 0, required: 2, status: '逾期', statusCls: 'tag-error', source: '检查记录', sourceCls: 'source-check' },
        { name: '安全标准化评审', freq: '每年1次', done: 0, required: 1, status: '逾期', statusCls: 'tag-error', source: '手动填报', sourceCls: 'source-manual' }
      ]
    },
