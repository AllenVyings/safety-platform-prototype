...
var orgList = [
  { id:'group', name:'深圳港集团', type:'单位', children:[
    { id:'d01', name:'安全管理部', type:'部门' },
    { id:'d02', name:'办公室', type:'部门' },
    { id:'d03', name:'党群工作部（企业文化部）', type:'部门' },
...
// ===== 用户数据 =====
var userList = [
  { id:1, userNo:'U20230001', name:'陈国安', login:'chenga', org:'安全管理部', orgId:'d01', oaOrg:'集团安全管理部', gender:'男', hireDate:'2019-03-15', roles:['系统管理员','安全管理员'], status:'启用', phone:'13800138001', remark:'' },
  { id:2, userNo:'U20230002', name:'林检查', login:'linjc', org:'安全管理部', orgId:'d01', oaOrg:'集团安全管理部', gender:'男', hireDate:'2020-06-01', roles:['安全主管'], status:'启用', phone:'', remark:'' },
  ...
  { id:24, userNo:'U20230024', name:'曹党群', login:'caodq', org:'党群工作部（企业文化部）', orgId:'d03', oaOrg:'集团党群工作部（企业文化部）', gender:'男', hireDate:'2017-03-22', roles:['普通用户'], status:'启用', phone:'', remark:'' },
  ...
  { id:30, userNo:'U20230030', name:'彭合规', login:'penghg', org:'合规部（董事会秘书处）', orgId:'d11', oaOrg:'集团合规部（董事会秘书处）', gender:'男', hireDate:'2022-06-08', roles:['普通用户'], status:'启用', phone:'', remark:'' },
  ...
  { id:33, userNo:'U20230033', name:'任盐建', login:'renyj', org:'深圳市盐田港建设指挥部办公室', orgId:'d16', oaOrg:'集团深圳市盐田港建设指挥部办公室', gender:'男', hireDate:'2018-10-15', roles:['安全主管'], status:'启用', phone:'', remark:'' },
  { id:34, userNo:'U20230034', name:'范安环', login:'fanah', org:'安全管理部', orgId:'u01-d01', oaOrg:'盐田港股份安环部', gender:'男', hireDate:'2020-05-12', roles:['安全主管'], status:'启用', phone:'', remark:'盐田港股份安环部' },
  ...
  { id:36, userNo:'U20230036', name:'鲁安环', login:'luah', org:'安全管理部', orgId:'u02-d01', oaOrg:'海洋发展安环部', gender:'男', hireDate:'2021-07-05', roles:['安全主管'], status:'启用', phone:'', remark:'海洋发展安环部' },
  { id:37, userNo:'U20230037', name:'汪安环', login:'wangah', org:'安全管理部', orgId:'u03-d01', oaOrg:'物流集团安环部', gender:'男', hireDate:'2020-01-15', roles:['安全管理员'], status:'启用', phone:'', remark:'物流集团安环部' },
  { id:38, userNo:'U20230038', name:'贺安环', login:'heah', org:'安全管理部', orgId:'u04-d01', oaOrg:'华舟海洋安环部', gender:'男', hireDate:'2022-03-18', roles:['安全管理员'], status:'启用', phone:'', remark:'华舟海洋安环部' },
  { id:39, userNo:'U20230039', name:'尹安环', login:'yinah', org:'安全管理部', orgId:'u05-d01', oaOrg:'能源发展安环部', gender:'女', hireDate:'2021-09-22', roles:['安全管理员'], status:'启用', phone:'', remark:'能源发展安环部' },
  { id:40, userNo:'U20230040', name:'卢安环', login:'luah2', org:'安全管理部', orgId:'u06-d01', oaOrg:'资本公司安环部', gender:'男', hireDate:'2020-06-30', roles:['安全管理员'], status:'启用', phone:'', remark:'资本公司安环部' },
  { id:41, userNo:'U20230041', name:'姚安环', login:'yaoah', org:'安全管理部', orgId:'u07-d01', oaOrg:'港口服务安环部', gender:'男', hireDate:'2019-04-10', roles:['安全管理员'], status:'启用', phone:'', remark:'港口服务安环部' },
  { id:42, userNo:'U20230042', name:'崔安环', login:'cuiah', org:'安全管理部', orgId:'u08-d01', oaOrg:'国际资讯安环部', gender:'男', hireDate:'2022-08-15', roles:['安全管理员'], status:'启用', phone:'', remark:'国际资讯安环部' },
  { id:43, userNo:'U20230043', name:'廖安环', login:'liaoah', org:'安全管理部', orgId:'u09-d01', oaOrg:'港口联运安环部', gender:'男', hireDate:'2021-02-28', roles:['安全管理员'], status:'启用', phone:'', remark:'港口联运安环部' },
  { id:44, userNo:'U20230044', name:'田安环', login:'tianah', org:'安全管理部', orgId:'u10-d01', oaOrg:'疏港铁路安环部', gender:'男', hireDate:'2020-10-12', roles:['安全主管'], status:'启用', phone:'', remark:'疏港铁路安环部' },
  { id:45, userNo:'U20230045', name:'石安环', login:'shiah', org:'安全管理部', orgId:'u11-d01', oaOrg:'深汕海洋安环部', gender:'男', hireDate:'2022-05-20', roles:['安全管理员'], status:'启用', phone:'', remark:'深汕海洋安环部' },
  { id:46, userNo:'U20230046', name:'龚安环', login:'gongah', org:'安全管理部', orgId:'u12-d01', oaOrg:'保税产业安环部', gender:'女', hireDate:'2021-11-08', roles:['安全管理员'], status:'启用', phone:'', remark:'保税产业安环部' },
  { id:47, userNo:'U20230047', name:'罗安环', login:'luoah', org:'安全管理部', orgId:'u13-d01', oaOrg:'东港区码头安环部', gender:'男', hireDate:'2019-08-25', roles:['安全管理员'], status:'启用', phone:'', remark:'东港区码头安环部' },
  { id:48, userNo:'U20230048', name:'覃安环', login:'qinah', org:'安全管理部', orgId:'u14-d01', oaOrg:'深赣港产城安环部', gender:'男', hireDate:'2023-01-10', roles:['安全管理员'], status:'待激活', phone:'', remark:'深赣港产城安环部-待激活' }
];
