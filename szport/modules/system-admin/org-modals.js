      ...
      <div class="modal-body">
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:0 20px;">
          ...
          <div class="form-group">
            ...
            <div class="form-content"><select class="form-input form-select" id="add-level"><option value="">请选择</option><option value="A级管控">A级管控</option><option value="B级管控">B级管控</option><option value="C级管控">C级管控</option><option value="一类考核部室">一类考核部室</option><option value="二类考核部室">二类考核部室</option></select></div>
          </div>
          <div class="form-group">
      ...
      <div class="modal-body">
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:0 20px;">
          ...
          <div class="form-group">
            ...
            <div class="form-content"><select class="form-input form-select" id="edit-level"><option value="">无</option><option value="A级管控">A级管控</option><option value="B级管控">B级管控</option><option value="C级管控">C级管控</option><option value="一类考核部室">一类考核部室</option><option value="二类考核部室">二类考核部室</option></select></div>
          </div>
          <div class="form-group">
